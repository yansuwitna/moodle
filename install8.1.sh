...
wget https://github.com/moodle/moodle/archive/refs/heads/MOODLE_405_STABLE.zip && chmod +x MOODLE_405_STABLE.zip && unzip MOODLE_405_STABLE.zip && rm -R /var/www/html/*
cp -R moodle-MOODLE_405_STABLE/* /var/www/html
ls -al /var/www/html
...
(crontab -u www-data -l 2>/dev/null; echo "*/5 * * * * /usr/bin/php /var/www/html/admin/cli/cron.php > /dev/null 2>&1") | crontab -u www-data -
